...
class CompatibilityMoneyTest extends PHPUnit_Framework_TestCase
{
    ...
    /**
     * @difference
     * Verraes' Money expected Exception \Keios\MoneyRight\Exceptions\InvalidArgumentException
     * This should pass with Keios\MoneyRight
     */
    ...
    public function testMultiplication()
    {
        ...
        $m2 = new Money(2, new Currency('EUR'));
        $m3 = new Money(1, new Currency('EUR'));
        $this->assertEquals(
            $m2->getAmount(),
            $m->multiply(1.5)->getAmount()
        );
        $this->assertEquals(
